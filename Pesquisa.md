...
- Cadastro	prévio	de	placas 
- Controle	de	isenções	(ex.:	médicos	em	hospitais)
- Lista	de	placas	para	eventos 
...
- Gestão	remota	do	pátio 
- Conformidade	com	alvarás	e	normas	municipais
